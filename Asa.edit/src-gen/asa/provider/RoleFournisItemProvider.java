...
/**
 * This is the item provider adapter for a {@link asa.RoleFournis} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleFournisItemProvider extends RoleItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RoleFournisItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addAttachementPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_RoleFournis_attachement_feature"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RoleFournis"));
	}
	...
	public String getText(Object object) {
		String label = ((RoleFournis) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_RoleFournis_type")
				: getString("_UI_RoleFournis_type") + " " + label;
	}
