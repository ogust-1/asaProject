...
/**
 * This is the item provider adapter for a {@link asa.Connecteur} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnecteurItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public ConnecteurItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Connecteur_Name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Connecteur_Name_feature",
								"_UI_Connecteur_type"),
						AsaPackage.Literals.CONNECTEUR__NAME, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Connecteur"));
	}
	...
	public String getText(Object object) {
		String label = ((Connecteur) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Connecteur_type")
				: getString("_UI_Connecteur_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Connecteur.class)) {
